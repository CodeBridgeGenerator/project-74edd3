...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.auth}</p>
...
<Column field="auth" header="Auth" body={pTemplate0} filter={selectedFilterFields.includes("auth")} hidden={selectedHideFields?.includes("auth")}  sortable style={{ minWidth: "8rem" }} />
